	   ...
	   <div class="portlet-body">
		         <div class="table-responsive">	
	                <table class="table">
						 ...
						 <td>Nick Name</td>
						 <td>
						    <input type="text" name="nick_name" id="nick_name"  value="<?=$nick_name?>" class="textbox">
						 </td>
				     </tr><tr>
						 <td>Username</td>
						 <td>
						 ...
						 <td>
		           		 ...
		           		 <td>Delivery Driver Job</td>
				   		 <td><?php
	$enumusers = getEnumFieldValues('users','delivery_driver_job');
?>
<select  name="delivery_driver_job" id="delivery_driver_job"   class="textbox">
<?php
   foreach($enumusers as $key=>$value)
   { 
?>
  <option value="<?=$value?>" <?php if($value==$delivery_driver_job){ echo "selected"; }?>><?=$value?></option>
 <?php
  }
?> 
</select></td>
