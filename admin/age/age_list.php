...
?>
<a href="index.php?cmd=edit" class="btn green">Add a age</a> <br><br>
				                ...
				                <table class="table">
									  <TR>
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_age" >
							...
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = type;	
										$info2['fields']   = array("type_name");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['type_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['type_name'];	
					                ?>
							   </td>
			  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = breed;	
										$info2['fields']   = array("breed_name");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['breed_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['breed_name'];	
					                ?>
							   </td>
			  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = gender;	
										$info2['fields']   = array("gender_name");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['gender_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['gender_name'];	
					                ?>
							   </td>
			  <td><?=$arr[$i]['age_name']?></td>
			  <td><?=$arr[$i]['status']?></td>
