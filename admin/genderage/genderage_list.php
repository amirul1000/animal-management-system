...
?>
<a href="index.php?cmd=edit" class="btn green">Add a genderage</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("genderage");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_genderage" >
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = breedgender;	
										$info2['fields']   = array("gender_name");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['breedgender_id']."' LIMIT 0,1";
