...
?>
<script language="javascript" src="breedgender.js"></script>
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_breedgender" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
...
<select  name="breed_id" id="breed_id"   class="textbox">
	...
	?> 
						 ...
						 <td>
		           		 ...
		           		 <td>Status</td>
				   		 <td><?php
	$enumbreedgender = getEnumFieldValues('breedgender','status');
?>
<select  name="status" id="status"   class="textbox">
<?php
   foreach($enumbreedgender as $key=>$value)
   { 
?>
