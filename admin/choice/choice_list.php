...
?>
<a href="index.php?cmd=edit" class="btn green">Add a choice</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("choice");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_choice" >
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td><?=$arr[$i]['from_contry']?></td>
                              <td><?=$arr[$i]['from_city']?></td>
                              <td><?=$arr[$i]['to_contry']?></td>
                              <td><?=$arr[$i]['to_city']?></td>
