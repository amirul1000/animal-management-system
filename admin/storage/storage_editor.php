	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_storage" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
...
<select  name="ad_id" id="ad_id"   class="textbox">
	...
	?> 
						 ...
						 <td>
		           		 ...
		           		 <td>Read Status</td>
				   		 <td><?php
	$enumstorage = getEnumFieldValues('storage','read_status');
?>
<select  name="read_status" id="read_status"   class="textbox">
<?php
   foreach($enumstorage as $key=>$value)
   { 
?>
