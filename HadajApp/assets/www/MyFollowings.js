/*
 * JS for MyFollowings generated by Appery.io
 */
...
function MyFollowings_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobileworkarea_10': 'MyFollowings_mobileworkarea_10',
        'mobilenavbar_6': 'MyFollowings_mobilenavbar_6',
        'favorite_item': 'MyFollowings_favorite_item',
        'home_item': 'MyFollowings_home_item',
        'upload_item': 'MyFollowings_upload_item'
    };
    ...
    Apperyio.CurrentScreen = 'MyFollowings';
    ...
    // On Load
    var MyFollowings_onLoad = function() {
            MyFollowings_elementsExtraJS();

            MyFollowings_deviceEvents();
            MyFollowings_windowEvents();
            MyFollowings_elementsEvents();
        };

    // screen window events


    function MyFollowings_windowEvents() {

        $('#MyFollowings').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function MyFollowings_deviceEvents() {
    ...
    function MyFollowings_elementsExtraJS() {
        // screen (MyFollowings) extra code
    ...
    function MyFollowings_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#MyFollowings_mobilefooter1 [name="favorite_item"]').on({
        ...
        }, '#MyFollowings_mobilefooter1 [name="favorite_item"]');
        $(document).off("click", '#MyFollowings_mobilefooter1 [name="home_item"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    user_info_data = Apperyio.storage.user_info.get();
                    if (typeof(user_info_data) === "undefined") {
        ...
        }, '#MyFollowings_mobilefooter1 [name="home_item"]');
        $(document).off("click", '#MyFollowings_mobilefooter1 [name="upload_item"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    user_info_data = Apperyio.storage.user_info.get();
                    if (typeof(user_info_data) === "undefined") {
        ...
        }, '#MyFollowings_mobilefooter1 [name="upload_item"]');

    };

    $(document).off("pagebeforeshow", "#MyFollowings").on("pagebeforeshow", "#MyFollowings", function(event, ui) {
        Apperyio.CurrentScreen = "MyFollowings";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#MyFollowings").on("pagecreate", "#MyFollowings", function(event, ui) {
