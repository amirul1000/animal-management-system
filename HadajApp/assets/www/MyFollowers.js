/*
 * JS for MyFollowers generated by Appery.io
 */
...
function MyFollowers_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobileworkarea_10': 'MyFollowers_mobileworkarea_10',
        'mobilenavbar_6': 'MyFollowers_mobilenavbar_6',
        'favorite_item': 'MyFollowers_favorite_item',
        'home_item': 'MyFollowers_home_item',
        'upload_item': 'MyFollowers_upload_item'
    };
    ...
    Apperyio.CurrentScreen = 'MyFollowers';
    ...
    // On Load
    var MyFollowers_onLoad = function() {
            MyFollowers_elementsExtraJS();

            MyFollowers_deviceEvents();
            MyFollowers_windowEvents();
            MyFollowers_elementsEvents();
        };

    // screen window events


    function MyFollowers_windowEvents() {

        $('#MyFollowers').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function MyFollowers_deviceEvents() {
    ...
    function MyFollowers_elementsExtraJS() {
        // screen (MyFollowers) extra code
    ...
    function MyFollowers_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#MyFollowers_mobilefooter1 [name="favorite_item"]').on({
        ...
        }, '#MyFollowers_mobilefooter1 [name="favorite_item"]');
        $(document).off("click", '#MyFollowers_mobilefooter1 [name="home_item"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    user_info_data = Apperyio.storage.user_info.get();
                    if (typeof(user_info_data) === "undefined") {
        ...
        }, '#MyFollowers_mobilefooter1 [name="home_item"]');
        $(document).off("click", '#MyFollowers_mobilefooter1 [name="upload_item"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    user_info_data = Apperyio.storage.user_info.get();
                    if (typeof(user_info_data) === "undefined") {
        ...
        }, '#MyFollowers_mobilefooter1 [name="upload_item"]');

    };

    $(document).off("pagebeforeshow", "#MyFollowers").on("pagebeforeshow", "#MyFollowers", function(event, ui) {
        Apperyio.CurrentScreen = "MyFollowers";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#MyFollowers").on("pagecreate", "#MyFollowers", function(event, ui) {
